...
| 8 | `supabase/patch-blogs-rls.sql` | If you deleted blogs RLS policies |
| 9 | `supabase/patch-profile-rls.sql` | If `profiles` RLS error or Profile not found |
| 10 | `supabase/patch-comments-admin-rls.sql` | If submitted comments missing in admin Pending |
